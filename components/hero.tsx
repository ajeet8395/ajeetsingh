      ...
      <div className="grid md:grid-cols-3 gap-10 items-center max-w-6xl mx-auto">
        ...
        >
          <div className="space-y-2">
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight">Ajeet Singh</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 text-sm text-muted-foreground">
            <div className="flex items-center gap-1">
              ...
              <a href="mailto:ajeetsi8395@gmail.com">ajeetsi8395@gmail.com</a>
            </div>
            <div className="flex items-center gap-1">
          ...
          <p className="text-muted-foreground text-sm sm:text-base">
            2+ years of experience as a goal-oriented software developer with experience in building web applications using modern technologies
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3">
            ...
            <Link
              href="mailto:ajeetsi8395@gmail.com"
              target="_blank"
            >
              <Button variant="outline" size="sm" className="text-xs sm:text-sm">
            ...
            <Link
              href="https://x.com/AjeetRa29447630"
              target="_blank"
            >
              <Button variant="outline" size="sm" className="text-xs sm:text-sm">
            ...
            <Link
              href="https://www.linkedin.com/in/ajeetsingh83/"
              target="_blank"
            >
              <Button variant="outline" size="sm" className="text-xs sm:text-sm">
